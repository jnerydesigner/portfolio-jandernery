...
const Header = () => {
  ...
  return (
    <>
      ...
      />
      <div className="w-[70%] h-[10vh] flex justify-center items-center flex-row  bg-portfolio-color02 relative drop-shadow-bottom">
        <div className="w-[90%] h-[10vh] flex justify-center items-center flex-row text-portfolio-color03 ">
        ...
        <div className="w-[10%] h-[10vh] flex justify-center items-center flex-row text-portfolio-color03 ">
